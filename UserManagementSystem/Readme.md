...
#### Add Users :
POST Method :  http://localhost:8080/User


#### Get All Users :
 - GET Method : http://localhost:8080/user/id/userid/1

 #### GET User By ID :
 - GET Method :   http://localhost:8080/getUserById/{id}

#### GET All Users :
 - GET Method :   http://localhost:8080/getAllUsers

 #### DELETE User :
 - DELETE Method :   http://localhost:8080user/4

  #### Update User ID :
 - PUT Method :   http://localhost:8086/updateId/id/10/updateId?updateId=5
